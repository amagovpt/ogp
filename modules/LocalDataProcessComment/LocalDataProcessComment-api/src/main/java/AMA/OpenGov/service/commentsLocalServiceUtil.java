...
/**
 * Provides the local service utility for comments. This utility wraps
 * {@link AMA.OpenGov.service.impl.commentsLocalServiceImpl} and is the
 ...
 * @see AMA.OpenGov.service.base.commentsLocalServiceBaseImpl
 * @see AMA.OpenGov.service.impl.commentsLocalServiceImpl
 * @generated
 */
@ProviderType
public class commentsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link AMA.OpenGov.service.impl.commentsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static AMA.OpenGov.model.comments addcomments(
	...
	*/
	public static AMA.OpenGov.model.comments createcomments(long id) {
		return getService().createcomments(id);
	}
	...
	*/
	public static AMA.OpenGov.model.comments deletecomments(
		AMA.OpenGov.model.comments comments) {
		return getService().deletecomments(comments);
	}
	...
	*/
	public static AMA.OpenGov.model.comments deletecomments(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletecomments(id);
	}

	public static AMA.OpenGov.model.comments fetchcomments(long id) {
		return getService().fetchcomments(id);
	}
	...
	* @throws PortalException if a comments with the primary key could not be found
	*/
	public static AMA.OpenGov.model.comments getcomments(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static AMA.OpenGov.model.comments updatecomments(
		AMA.OpenGov.model.comments comments) {
	...
	*/
	public static java.util.List<AMA.OpenGov.model.comments> getcommentses(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<commentsLocalService, commentsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(commentsLocalService.class);
}