...
/**
 * Provides the local service interface for comments. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see commentsLocalServiceUtil
...
public interface commentsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link commentsLocalServiceUtil} to access the comments local service. Add custom service methods to {@link AMA.OpenGov.service.impl.commentsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public comments createcomments(long id);
	...
	*/
	...
	public comments deletecomments(comments comments);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public comments deletecomments(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public comments fetchcomments(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public comments getcomments(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<comments> getcommentses(int start, int end);
