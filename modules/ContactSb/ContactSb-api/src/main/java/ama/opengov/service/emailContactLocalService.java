...
/**
 * Provides the local service interface for emailContact. Methods of this
...
public interface emailContactLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link emailContactLocalServiceUtil} to access the email contact local service. Add custom service methods to {@link ama.opengov.service.impl.emailContactLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public emailContact addemailContact(emailContact emailContact);
	...
	*/
	public emailContact createemailContact(long id);
	...
	*/
	...
	public emailContact deleteemailContact(emailContact emailContact);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public emailContact deleteemailContact(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public emailContact fetchemailContact(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public emailContact getemailContact(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<emailContact> getemailContacts(int start, int end);
