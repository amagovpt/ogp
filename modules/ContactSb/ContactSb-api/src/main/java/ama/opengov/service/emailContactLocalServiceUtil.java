 ...
 * {@link ama.opengov.service.impl.emailContactLocalServiceImpl} and is the
 ...
 * @see ama.opengov.service.base.emailContactLocalServiceBaseImpl
 * @see ama.opengov.service.impl.emailContactLocalServiceImpl
 * @generated
 */
@ProviderType
public class emailContactLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link ama.opengov.service.impl.emailContactLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static ama.opengov.model.emailContact addemailContact(
		ama.opengov.model.emailContact emailContact) {
	...
	*/
	public static ama.opengov.model.emailContact createemailContact(long id) {
	...
	*/
	public static ama.opengov.model.emailContact deleteemailContact(
		ama.opengov.model.emailContact emailContact) {
	...
	*/
	public static ama.opengov.model.emailContact deleteemailContact(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteemailContact(id);
	}

	public static ama.opengov.model.emailContact fetchemailContact(long id) {
	...
	* @throws PortalException if a email contact with the primary key could not be found
	*/
	public static ama.opengov.model.emailContact getemailContact(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static ama.opengov.model.emailContact updateemailContact(
		ama.opengov.model.emailContact emailContact) {
	...
	*/
	public static java.util.List<ama.opengov.model.emailContact> getemailContacts(
		int start, int end) {
