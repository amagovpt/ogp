...
/**
 * Provides the local service utility for ogp_comments. This utility wraps
 * {@link AMA.OpenGov.LocalDataSaveEmail.service.impl.ogp_commentsLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class ogp_commentsLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link AMA.OpenGov.LocalDataSaveEmail.service.impl.ogp_commentsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments addogp_comments(
		AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments ogp_comments) {
		return getService().addogp_comments(ogp_comments);
	}
	...
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments createogp_comments(
		long id) {
		return getService().createogp_comments(id);
	}
	...
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments deleteogp_comments(
		AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments ogp_comments) {
		return getService().deleteogp_comments(ogp_comments);
	}
	...
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments deleteogp_comments(
		...
		return getService().deleteogp_comments(id);
	}

	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments fetchogp_comments(
		long id) {
		return getService().fetchogp_comments(id);
	}
	...
	* @throws PortalException if a ogp_comments with the primary key could not be found
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments getogp_comments(
		long id) throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getogp_comments(id);
	}
	...
	*/
	public static AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments updateogp_comments(
		AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments ogp_comments) {
		return getService().updateogp_comments(ogp_comments);
	}
	...
	*/
	public static int getogp_commentsesCount() {
		return getService().getogp_commentsesCount();
	}
	...
	*/
	public static java.util.List<AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments> getogp_commentses(
		int start, int end) {
		return getService().getogp_commentses(start, end);
	}
	...
	*/
	...
	public static ogp_commentsLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ogp_commentsLocalService, ogp_commentsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ogp_commentsLocalService.class);
}