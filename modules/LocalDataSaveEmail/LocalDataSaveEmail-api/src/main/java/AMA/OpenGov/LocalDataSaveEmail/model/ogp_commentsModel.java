...
/**
 * The base model interface for the ogp_comments service. Represents a row in the &quot;AMA_ogp_comments&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link AMA.OpenGov.LocalDataSaveEmail.model.impl.ogp_commentsModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AMA.OpenGov.LocalDataSaveEmail.model.impl.ogp_commentsImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface ogp_commentsModel extends BaseModel<ogp_comments> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ogp_comments model instance should use the {@link ogp_comments} interface instead.
	 */
	...
	@Override
	public CacheModel<AMA.OpenGov.LocalDataSaveEmail.model.ogp_comments> toCacheModel();
